...
class View implements Renderer {
    ...
    * @access public
	 ...
	 */
	public function getView($identifier) {
	 ...
	 * sets parent view
	 * 
	 * DO NOT call this function manullay.  This will be automatically set when adding as subview
    * @access public
	 * @return void
	 * @param \oxide\application\View $view
	 */
	public function setContainerView(View $view) {
    ...
    * @access public
	 ...
	 * 
	 * if view is set to pre render, then it will rendered first by parent view (if any) before itself is rendered
    * @access public
    * @param object $bool
	 */
    ...
    * @param type $args
    */
   protected function executeScript($script, $args = null) {
      if($args) {
         extract($args);
      }
